...
export default function Contact() {
  ...
  return (
    <section id="contact" className="z-0 relative bg-neutral-950 px-6 py-20 scroll-mt-32">
      <div ref={sectionRef} className="z-10 relative px-4 sm:px-8 text-white">
        <h3 className="bg-clip-text bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 font-semibold text-transparent text-3xl sm:text-4xl text-center">
          Jackson Bryant
        </h3>
